...
public final class PermissionUsages implements LoaderCallbacks<List<AppPermissionUsage>> {
    ...
    //private staticArrayList<PermissionHistory> historicalData = new ArrayList<>();
    ...
    public List<AppPermissionUsage> getPermissionUsagesSynchronously(int filterUid, @Nullable String filterPackageName,
        @Nullable String[] filterPermissionGroups, long filterBeginTimeMillis, long filterEndTimeMillis,
        int usageFlags, boolean getUiInfo, boolean getNonPlatformPermissions) {
        ...
        UsageLoader loader = new UsageLoader(mContext, args);
        return loader.loadInBackground();  // Directly invoke the background loading method.
    }
