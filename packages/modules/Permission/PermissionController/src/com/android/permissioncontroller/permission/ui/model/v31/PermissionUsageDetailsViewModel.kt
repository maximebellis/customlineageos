...
class PermissionUsageDetailsViewModel(
    ...
    fun parseUsages(
        ...
        Log.d("PermissionData", "Current Time: $curTime")
        Log.d("PermissionData", "Show Usage Duration: $showPermissionUsagesDuration")
        Log.d("PermissionData", "Start Time: $startTime")
        Log.d("PermissionData", "Filter Group: $filterGroup")

        Log.d("PermissionData", "Exempted Packages: $exemptedPackages")
        Log.d("PermissionData", "AppPermissionUsages: $appPermissionUsages")
            ...
            .map { usageData: UsageData ->
                ...
                for (groupIndex in 0 until numGroups) {
                    ...
                    for (discreteAccessTime in timelineUsage.allDiscreteAccessTime) {
                        ...
                        // Log the details with formatted date-time
                        Log.d("PermissionLog", "App: ${usageData.app.packageName}, Permission: ${timelineUsage.group.name}, Access Time: $accessTimeStr")
                    }
                }
