    ...
    fun extractGroupUsageLastAccessTime(
        ...
        for (appIndex in 0 until numApps) {
            ...
            for (groupIndex in 0 until numGroups) {
                ...
                if (groupName == Manifest.permission_group.LOCATION) {
                	Log.d("LocationTrackerApp", "Location permission accessed by $packageName at ${Instant.ofEpochMilli(lastAccessTime)}")
            	}
